...
![](https://shared.fastly.steamstatic.com/store_item_assets/steam/apps/341800/ss_55f22f9996c327c281d241ed09d43c74337d7e30.1920x1080.jpg?t=1699020889)

Trang web chính thức của trò chơi: [https://keeptalkinggame.com/](https://keeptalkinggame.com/)

## 1.2. Cẩm nang Gỡ bom
Trong tựa game giải đố hợp tác đầy kịch tính "Keep Talking and Nobody Explodes", cuốn Cẩm nang Gỡ bom (Bomb Defusal Manual) là một yếu tố then chốt, đóng vai trò là nguồn thông tin duy nhất và quan trọng nhất để hoàn thành mục tiêu.
...
activate gui
alt GUI thread
    gui->>gui: Process event function
    activate gui
