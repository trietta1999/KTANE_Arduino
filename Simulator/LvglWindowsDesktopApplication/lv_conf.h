...
#define LV_COLOR_DEPTH 16 //32  //(LV_COLOR_16_SWAP is abandoned by LVGL9, but lv_draw_sw_rgb565_swap() can be added to display flush function)
...
#define LV_USE_STDLIB_SPRINTF   LV_STDLIB_CLIB
    ...
    #define LV_MEM_SIZE (64U * 1024U * 1024U)  //(256 * 1024U)          /*[bytes]*/
...
#define LV_FONT_MONTSERRAT_24 0 //0
...
#define LV_USE_TJPGD 0 //1 //0  //compile error with MSbuild
...
#define LV_USE_SYSMON   1
    ...
    #define LV_USE_PERF_MONITOR 0 //1
...
#define LV_USE_DEMO_BENCHMARK 0 //1
...
/*Flex layout demo*/
#define LV_USE_DEMO_FLEX_LAYOUT     0 //1 //0
