...
#define CLIENT_NAME mapWstr_MODULE_NAME[MODULE_NAME::CapacitorDischarge].c_str()
#define CLIENT_NAME_FOR_JSON map_MODULE_NAME[MODULE_NAME::CapacitorDischarge].c_str()
#else
#define HOST_NAME map_MODULE_NAME[MODULE_NAME::HostTimer].c_str()
#define CLIENT_NAME map_MODULE_NAME[MODULE_NAME::CapacitorDischarge].c_str()
#endif
...
#define IP_ADD_2 168
#define IP_ADD_3 0
#define IP_ADD_4 (uint8_t)MODULE_NAME::CapacitorDischarge
